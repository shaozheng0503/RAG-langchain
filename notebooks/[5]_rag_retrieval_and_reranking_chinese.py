...
本脚本演示了检索增强生成 (RAG) 系统中的高级检索和重新排序技术。
包括多查询生成、倒数排名融合、Cohere 重新排序等高级功能。
...
#                "langchain-openai", "langchainhub", "chromadb", "langchain", "cohere"])
...
def main():
    """
    主函数：演示 RAG 检索和重新排序功能
    """
    print("开始 RAG 检索和重新排序演示...")
